...
TOTAL_NUM_REQS = 10
NUM_OF_CLIENTS = 1
_REQS_PER_CLIENT = int(TOTAL_NUM_REQS / (NUM_OF_NODES * NUM_OF_CLIENTS))
...
if __name__=='__main__':
    ...
    print("Attempting single request insultMe to rabbit...")
    multiConnectClient(queue=INSULT_MANAGER_QUEUE, method="insultMe", reps=1)
